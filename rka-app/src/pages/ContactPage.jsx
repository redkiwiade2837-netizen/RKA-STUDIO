  ...
  if (status === 'sent') {
    return (
      <div className="flex-grow px-page-margin py-section-gap flex flex-col gap-section-gap max-w-3xl">
        <header>
          <h1 className="font-page-title text-page-title">{t('contact.title')}</h1>
        </header>
        <p className="font-body text-body">
          {t('contact.thanks')(form.email)}
        </p>
  ...
  return (
    <div className="flex-grow px-page-margin py-section-gap flex flex-col gap-section-gap max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-md">
        <div>
          <label className="font-body-bold text-caption uppercase tracking-wider">{t('contact.category')}</label>
          <select
            required
        ...
        <div>
          <label className="font-body-bold text-caption uppercase tracking-wider">{t('contact.email')}</label>
          <input
            type="email"
            required
            className="input-brutal"
        ...
        <div>
          <label className="font-body-bold text-caption uppercase tracking-wider">{t('contact.message')}</label>
          <textarea
            required
            rows={6}
